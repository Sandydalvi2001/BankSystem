...
public class UserDatas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(UserDatas.this);
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(UserDatas.this);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(UserDatas.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DataBaseHelper(UserDatas.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
                        Toast.makeText(UserDatas.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
...
//    String phonenumber;
//    Double newbalance;
//    TextView name, mobileNumber, email, account_no, ifsc_code, balance;
//    Button transfer_button;
//    AlertDialog dialog;
//
//    @Override
...
//
//        name = findViewById(R.id.username);
//        mobileNumber = findViewById(R.id.userphonenumber);
//        email = findViewById(R.id.email);
//        account_no = findViewById(R.id.account_no);
//        ifsc_code = findViewById(R.id.ifsc_code);
//        balance = findViewById(R.id.balance);
...
//
//
//            mobileNumber.setText(cursor.getString(0));
//            name.setText(cursor.getString(1));
//            email.setText(cursor.getString(3));
//            balance.setText(price);
//            account_no.setText(cursor.getString(4));
