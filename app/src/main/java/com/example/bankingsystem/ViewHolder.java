...
public class ViewHolder extends RecyclerView.ViewHolder{
    ...
    public ViewHolder(@NonNull View itemView) {
        ...
        mTransc_status = itemView.findViewById(R.id.transac_status);
...
//    TextView mName, mPhonenumber, mBalance, mRupee, mRupeeslash, mName1, mName2, mDate, mTransc_status,mAmount;
//    ImageView mPhone, mArrow;
//    View mView;
//
//    public ViewHolder(@NonNull View itemView) {
...
//
//        mName = itemView.findViewById(R.id.userName);
//        mPhonenumber = itemView.findViewById(R.id.userNumber);
//        mBalance = itemView.findViewById(R.id.amount);
//        mAmount =itemView.findViewById(R.id.balance);
//        mRupee = itemView.findViewById(R.id.tv_rs);
//        mRupeeslash = itemView.findViewById(R.id.rv_slash);
//        mName1 = itemView.findViewById(R.id.name1);
//        mName2 = itemView.findViewById(R.id.name2);
//        mDate = itemView.findViewById(R.id.date);
//        mArrow = itemView.findViewById(R.id.arrow);
